...
class Rsaigl extends React.Component{
    constructor(props) {
		super(props);
    this.state = {
        url:"https://digiapricus.com/rsaigl",
        title:"Digi Apricus - Blog/ RSA IGL",
        hashtag:"#digiapricus",
...
render(){
      ...
      <div>
          ...
          <div className="contentbox">
                <h4 className="pagehead">Blog / RSA IGL</h4>
        </div>         
            </section>
        <section className="section colored" id="dk_learning">
        <h1 className="ndpage">RSA IGL</h1>
              ...
              <div className="row">
                    ...
                    <div className="left-text">
                        <p>RSA IGL is a complete solution for managing digital identities, both inside and outside of the enterprise. The RSA solution covers all aspects of governance and identity lifecycle, including provisioning, entitlement assignment, access reconciliation, and approval<br/>
                           <br/> </p>
                    </div>
